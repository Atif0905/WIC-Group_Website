      ...
      <nav>
        <div className="wrapper">
          ...
          <ul className="nav-links">
            ...
            <li>
              <a href="/Bussiness" className="desktop-item">
                Business
              </a>
              ...
              <div className="mega-box">
                <div className="content">
                  <div className="row">
                    <img
                      src="https://www.adani.com/-/media/Project/Adani/Blog/Dharavi-Oped-Image-min.jpg"
                      alt=""
                    />
                  </div>
            ...
            <li>
              <a href="about" className="desktop-item">
                About
              </a>
              <input type="checkbox" id="showMega" />
              <label for="showMega" className="mobile-item">
                  ...
                  <div className="row">
                    ...
                    <ul className="mega-links">
                      <li>
                        <a
                          className=" h6 mt-3 "
                          href="./AboutPage/OneVission/OneVission"
                        >
                          One Vision One Team
                        </a>
                      </li>
                      <li>
                        <a className=" h6 mt-3 " href="./AboutPage/CEO/Ceo">
                          CEO's Message
                        </a>
                      </li>
                    </ul>
            ...
            <li>
              <a href="/Career" className="desktop-item">
                Careers
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="contact" className="desktop-item">
                Connect
              </a>
              <input type="checkbox" id="showMega" />
              <label for="showMega" className="mobile-item">
              ...
              <div className="mega-box">
                <div className="content">
                  ...
                  <div className="row">
                    ...
                    <ul className="mega-links">
                      <li>
                        <a className=" h6 mt-3 " href="/BookAnAppoinment">
                          Book An Appointment
                        </a>
                      </li>
                      <li>
                        <a className=" h6 mt-3 " href="/ConatctForQuery">
                          Contact For Query
                        </a>
                      </li>
                    </ul>
