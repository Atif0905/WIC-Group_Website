...
import "swiper/css";
import styles from './CareerCard4.module.css'
import data from './CareerCard4.json'
    ...
    <div className='container'>
      <div className='row'>
        ...
        {data.Section1.map((NewData) => {
            ...
            <h5 className={styles.card4head}>{NewData.Heading}</h5>
            <p className={styles.card4text}>{NewData.Content}</p>
            </div>
            </div>      
        )
        })}
         ...
         {data.Section2.map((NewData) => {
          ...
          <div className=" d-flex">
              ...
              <div className="col-lg-6 col-md-6 col-sm-12 p-5">
                <div className={styles.carouselcard4head}>
                <h5 className="text-center">{NewData.Heading}</h5>
                </div>
                <div className={styles.carouselcard4text}>
